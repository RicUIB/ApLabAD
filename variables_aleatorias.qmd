...
Hasta ahora nuestros sucesos han sido de varios tipos: $\{C,+\}$ en la moneda, nombres de periódicos, ángulos en una ruleta, número de veces que sale cara en el lanzamiento de una moneda etc\ldots.
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Variable Aleatoria (definición práctica)</i>
:::
::: callout-body
...
::::: callout-nota
::: callout-title
<i class="bi bi-info-circle"> Notación </i>  
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-info-circle"> Ejemplo</i>  
:::
::: callout-body
...
::::: callout-definicion
::: callout-title
<i class="bi bi-info-circle">Variables Aleatorias Discretas y Continuas</i>
:::
::: callout-body
- Una variable aleatoria es **discreta** si sólo puede tomar una cantidad 
numerable de valores con probabilidad positiva.
- Las variables aleatorias **continuas** toman valores en intervalos.
- También existen las variables aleatorias **mixtas**; con una parte discreta 
y otra continua.
:::
:::::
...
Pasamos ahora a describir el comportamiento de la v.a. Para ello utilizaremos 
distintas funciones que nos darán algunas probabilidades de la variable aleatoria.

En el caso discreto estas funciones son la de probabilidad, y la función de 
distribución o de probabilidad acumulada.
...
::::: callout-definicion
::: callout-title
<i class="bi bi-info-circle">Función de Probabilidad</i>
:::
::: callout-body
La **función de probabilidad** (*probability mass function* o incluso abusando 
de notación *probability density function*) de una variable aleatoria discreta 
$X$ a la que denotaremos por $P_{X}(x)$ está definida por
...
de **dominio** de la v.a. y son los valores posibles de esta variable.
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-info-circle"> Ejemplo: Dado de parchís</i>
:::
::: callout-body

Lanzamos un dado de parchís una vez, en esta ocasión representaremos los 
sucesos elementales por el número de puntos de la cara obtenida, tenemos que $$\Omega=\{\mbox{1-puntos,2-puntos,3-puntos,4-puntos,5-puntos,6-puntos}\}$$ 
...
::::: callout-definicion
::: callout-title
<i class="bi bi-info-circle"> Ejemplo: lanzamiento moneda </i>
:::
::: callout-body

Sea $X$ la v.a. asociada al lanzamiento de una moneda. Su espacio muestral 
es $\Omega=\{c,+\}$, la v.a. queda definida por:
...
::::: callout-definicion
::: callout-title
<i class="bi bi-info-circle">  Ejemplo: urna con bolas</i>
:::
::: callout-body
Tenemos una urna con tres bolas rojas, una negra y dos blancas. Realizamos una
extracción y observamos el color de la bola entonces un espacio muestral es 
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Propiedades básicas de la función de 
probabilidad</i>
:::
::: callout-body

Sea $X$ una v.a. discreta $X:\Omega:\to\mathbb{R}$ con dominio $D_X$. 
Su función de probabilidad $P_{X}$ verifica las siguientes propiedades:
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-info-circle"> Ejemplo: lanzmiento moneda</i>
:::
::: callout-body
Lanzamos al aire tres veces, de forma independiente, una moneda perfecta. 
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Función de distribución de Probabilidad (acumuladada)</i>
:::
::: callout-body
La función de *distribución de probabilidad* (acumulada) de la v.a. $X$ 
(de cualquier tipo; discreta o continua) $F_{X}(x)$ representa la 
probabilidad de que $X$ tome un menor o igual que $x$, es decir,

$$F_{X}(x)=P(X\leq x).$$

Esta función también se denomina función de **distribución de probabilidad 
o simplemente función de distribución** de una v.a., y en inglés *cumulative 
distribution function* por lo que se abrevia con el acrónimo `cdf`.
:::
:::::
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-book"> Propiedades de la Función de Distribución </i> 
:::
::: callout-body
...
::::: callout-advertencia
::: callout-title
<i class="bi bi-exclamation-triangle"> Advertencia: Desigualdades estrictas </i> 
:::
::: callout-body
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Más propiedades de la función de distribución  </i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"></i> Ejemplo: dado (continuación)
:::
::: callout-body
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Esperanza de una variable aleatoria discreta</i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo: Intepretación de de la media</i>
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo: Erratas en un texto</i> 
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Propiedad: Esperanzas de funciones
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-clipboard-check"></i> Ejemplo: paleta de colores aleatoria
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Propiedades </i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-clipboard-check"> Ejemplo: paleta de colores (continuación)</i>
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check">Definición: Momentos de orden $m$ </i> 
:::
::: callout-body
...
::::: callout-definición
::: callout-title
<i class="bi bi-clipboard-check"> Definición: Varianza</i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task">Ejemplo: número de errores (continuación) </i>
:::
::: callout-body
...
## Transformaiones lineales de v.a.

::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Transformación lineal </i>
:::
::: callout-body
...
::::: callout-propiedad
::: callout-title
<i class="bi bi-book"> Propiedad: Esperanza de una transformación lineal </i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo: Distribución uniforme en $[0,1]$</i>
:::
::: callout-body
...
```{r figUNIF, fig.align='center',out.width="100%"}
...
:::
::: callout-body
En las variables continuas los sucesos del tipo $\{X\leq x \}$ y $\{X< x \}$ tendrán la misma probabilidad.
Otras identidades similares son :
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Propiedades de la Función de Distribución </i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo </i> Ejemplo
:::
::: example
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Definición: Función de densidad </i> 
:::
::: callout-body
...
::::: callout-teorema
::: callout-title
<i class="bi bi-book"> Propiedad: Relación entre la función de distribución y la densidad</i>  
:::
::: callout-body
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Definición: Dominio de una variable aleatoria continua</i>  
:::
::: callout-body

El conjunto $D_X=\{x\in\mathbb{R}| f_x(x)>0\}$ recibe el nombre de <l class="definition"> soporte o dominio de la variable aleatoria continua</l> y se interpreta como su conjunto de resultados posibles.
:::
:::::
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-book"> Ejemplo: diana (continuación) </i>  
:::
::: callout-body
...
```{r fig.align="center", fig_caption="Función de densidad de una v.a. uniforme en el intervalo$(0,1)$",out.width="100%"}
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-book"> Propiedades </i>  
:::
::: callout-body
...
-   Sea $X$ una v.a. continua con función de distribución $F_X$ y de densidad $f_X$, 
...
Sea $X$ una v.a. continua con función de distribución $F_X$ y 
de densidad $f_X$, entonces:
...
::::: callout-ejercicio
::: callout-title
<i class="bi bi-book"> Ejercicio </i>  
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-book"> Ejemplo tiempo ejecución de un proceso</i>  
:::
::: callout-body
...
-   $F_X(x)=\displaystyle\int_{-\infty}^x f_X(t) dt,$ para todo $x\in \mathbb{R}$ <l class="exercise">(Ejercicio: resolverlo gráficamente.)</l>
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-book"> Ejercicio: Tiempo de un proceso </i>  
:::
::: callout-body
...
$X$ es una variable aleatoria continua con función de densidad $f_{X}(x)$

::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Definición: Esperanza  y Varianza v.a. continuas</i> 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo: Diana (continuación) </i>
:::
::: callout-body
...
## Esperanza de transformaciones lineales de v.a. continuas
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-clipboard-check"> Ejemplo </i>
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check">Propiedad: Transformaciones de v.a. discretas </l>
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check">Propiedad: Transformación de v.a. continuas en continuas**
 </l>
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Densidad de una transformación de una v.a. continua </i> 
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Propiedad: Desigualdad de Markov </i>
:::
:::   callout-body    
...
Se deja como **ejercicio** la prueba del corolario anterior a partir 
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Propiedad: Desigualdad de Chebychev</i>
:::
::: callout-body

La **desigualdad de Chebychev** también se escribe de Chebyshov y en inglés 
*Chebyshev*.
...
::::: callout-nota
::: callout-title
<i class="bi bi-info-circle"> Utilidad básica de la desigualdad de Chebychev </i>
:::
::: callout-body
...
Por lo que la probabilidad de que $X$ sea constantemente $E(X)$ es 1, 
hecho que nos confirma la utilidad de la varianza como una medida de la 
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task">Ejemplo: tiempo de respuesta</i> 
:::

::: callout-body

Se sabe que el tiempo de respuesta medio y la desviación típica de un sistema 
multiusuario son 15 y 3 unidades de tiempo respectivamente. Entonces:
