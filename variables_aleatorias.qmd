...
:::
::: callout-body
Esta es una **definición práctica** para empezar a trabajar. Más adelante daremos la formulación rigurosa (funciones medibles y $\sigma$-álgebras).
:::
:::::
...
::::: callout-proposicion
::: callout-title
Propiedades básicas de la función de 
probabilidad
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
Propiedad: Esperanzas de funciones
...
## Transformaciones lineales de v.a.
...
::::: callout-teorema
::: callout-title
<i class="bi bi-lightbulb"> Propiedad: Relación entre la función de distribución y la densidad  
:::
::: callout-body
...
::::: callout-ejercicio
::: callout-title
<i class="bi bi-pencil-square"> Ejercicio   
:::
::: callout-body
...
::::: callout-ejercicio
::: callout-title
<i class="bi bi-pencil-square"> Ejercicio: Tiempo de un proceso   
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
Propiedad: Transformaciones de v.a. discretas </l>
:::
::: callout-body
