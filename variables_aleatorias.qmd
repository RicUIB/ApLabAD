...
::::: callout-propiedad
::: callout-title
<i class="bi bi-book">EPorpiedad: Esperanza de una trnaformación lineal </i> 
:::
::: callout-body
...
```{r figUNIF, fig.align='center',out.width="45%"}
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"></i> Definición: Función de densidad 
:::
::: callout-body
...
::::: callout-teorema
::: callout-title
<i class="bi bi-book"> Propiedad: relación entre la función de distribcuión y la densidad</i>  
:::
::: callout-body
...
```{r fig.align="center", fig_caption="Función de densidad de una v.a. uniforme en el intervalo$(0,1)$",out.width="50%"}
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Propiedad: Desigualdad de Markov
:::
