...
::::: {callout-definicion}
::: {callout-title}
<i class="bi bi-book"> Definición de conjunto</i>
:::
::: {callout-body}
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Intersección de conjuntos</i>
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Unión de conjuntos</i>
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Diferencia de conjuntos</i>
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Complementario</i> 
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Número combinatorio o número binomial</i>
:::
...
::::: callout-ejercicio
::: callout-title
<i class="bi bi-pencil-square">Ejercicio: el paquete `gtools`</i>
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Combinaciones con repetición</i>
:::
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo: caramelos</i> 
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Variaciones</i>
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Variaciones con repetición</i>
:::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Permutaciones</i> 
:::
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"> Ejemplo: dígitos</i> 
:::
...
::::: callout-teorema
::: callout-title
<i class="bi bi-lightbulb"> El principio de la suma</i>
:::
...
::::: callout-teorema
::: callout-title
<i class="bi bi-lightbulb"> Principio de unión exclusión</i>
:::
...
::::: callout-teorema
::: callout-title
<i class="bi bi-lightbulb"> El principio del producto</i>
:::
