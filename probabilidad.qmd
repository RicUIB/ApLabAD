...
-   **Suceso imposible o vacío**: \(\emptyset\)
...
```{r  pepe, echo=FALSE, out.width="50%",fig.align='center'}
#| fig-align: center
#|
...
| $A\cap B$ | $(A\cap B)^c$ |
|:----------------------------------:|:----------------------------------:|
| ![](Images/venn1AyB.jpeg){height="150px"} | ![](Images/_book/Images/venn1interseccioncomplementarios.jpeg){height="145px"} |

$$(A\cap B)^c=A^c\cup B^c$$

| $A^c$ | $B^c$ | $A^c\cup B^c$ |
|:----------------------:|:----------------------:|:----------------------:|
| ![](Images/venn1Ac_conB.jpeg){height="150px"} | ![](Images/venn1Bc_conA.jpeg){height="150px"} | ![](Images/venn1Ac_conB.jpeg){height="145px"} |
...
-   $A\setminus B$: dar positivo en cocaína pero no en cannabis, por lo tanto
tenemos que :
...
## Clasificación o diagnóstico caso binario
