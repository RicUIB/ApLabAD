...
:::
::: callout-body
Experimento aleatorio</l>: experimento que repetido en las mismas condiciones puede dar resultados diferentes, pero que a largo plazo son predecibles
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"></i> Suceso elemental
:::

::: callout-body
Cada uno de los posibles resultados del experimento aleatorio
:::
::::
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"></i> Espacio Muestral
:::
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-pencil-square"></i>  Ejemplo $n$-grama
:::
::: callout-body
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-list-task"></i> Para la unión de tres conjuntos
:::
...
De forma  analítica la demostración es la siguiente:
...
::: example
-sol - ¿Cuál es la probabilidad de que un chica lleve gafas?
...
::: example
-sol - ¿Cuál es la probabilidad de que un alumno que lleve gafas sea mujer?
...
::: example
-sol entonces podemos definir el suceso:
...
::: example
-sol de donde, la probabilidad condicionada de ser hipertenso creyéndonos que lo somos es:
...
::: example
-sol - $A$: llevar adjuntos; $P(A)=0.5$, - $S$: SPAM; $P(S)=0.65$, - $A^c\cap S^c=(A\cup S)^c$: no llevar adjunto y no ser SPAM; $P((A\cup S)^c)=0.15$,
...
::: example
-sol - $P(A)=0.5, P(S)=0.65, P(A^c\cap S^c)=P((A\cup S)^c)=0.15$,
...
<l class="definition"> Positivos y Negativos</l> Consideremos un problema de predicción de clases binario, en la que los resultados se etiquetan positivos (P) o negativos (N). Hay cuatro posibles resultados a partir de un clasificador binario como el propuesto.
...
::: example
-sol Los datos del problema son:
...
::: example
-sol - $P(T)=0.15$, $P(T^c|M)=0.06$, $P(T|M^c)=0.04.$
...
::: example
-sol Los sucesos del ejemplo son:
...
::: example
-sol - Los sucesos del ejercicio son $A$: el cliente es de tipo A, $B$: el cliente es de tipo B, $C$: el cliente es de tipo C y
...
::: example
-sol Definimos los sucesos y datos del ejercicio:
...
::: exercice
-sol $$P(B)=0.02, P(T|B)=0.975, P(T|B^c)=0.12.$$
...
::: example
-sol Los sucesos y datos del ejemplo son:
