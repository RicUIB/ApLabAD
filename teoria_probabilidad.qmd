...
Lo haremos de forma esquemáica dejando las demostraciones que sean  fáciles o medias al lector, como ejercicio.
...
::: callout-content
Sea $\Omega$ un conjunto y $\mathcal{A}\subseteq \mathcal{P}(\Omega)$ una familia de subconjuntos de $\Omega$ diremos que $\mathcal{A}$ es una álgebra de $\Omega$ si: 1. $\Omega\in\mathcal{A}$ 2. $A\in\mathcal{A}\Rightarrow A^c\in\mathcal{A}$ 3. $A_1,A_2,\ldots,A_n \in\mathcal{A}\Rightarrow \bigcup_{i=1}^{\infty}A_i\in\mathcal{A}$ para todo $n\in\mathbb{N}$
...
::::: callout-ejemplos
::: callout-title
<i class="bi bi-book"> Alguns $\sigma$-álgebras famosas </i>
:::
