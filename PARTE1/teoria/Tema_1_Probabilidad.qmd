...
\blue{Experimento aleatorio}: experimento que repetido en las mismas condiciones puede dar resultados diferentes, pero que a largo plazo son predecibles
...
\blue{Suceso elemental}: cada uno de los posibles resultados del experimento aleatorio

**Ejemplo**

Los sucesos elementales del ejemplo anterior son:

```{r fig.show = "hold", echo=FALSE,out.width = "65%",fig.align='center'}
knitr::include_graphics("Images/dados1a6.png")
```
...
\blue{Espacio muestral}: el conjunto $\Omega$ formado por todos los sucesos elementales del experimento aleatorio
...
\blue{Suceso } : Cualquier subconjunto del espacio muestral.

Alguno sucesos notables que merece la pena nombrar son:

-   \blue{Suceso seguro o cierto}: $\Omega$
-   \blue{Suceso imposible o vacio}: $\emptyset$
-   \blue{Partes de un conjunto}: $\mathcal{P}(\Omega)$: conjunto de todos los sucesos del experimento aleatorio (es decir, el conjunto de todos los subconjuntos de $\Omega$)
...
\blue{Sucesos incompatibles}: $A$ y $B$ son *incompatibles* (o *disjuntos*) cuando $A\cap B=\emptyset$.
...
|:----------------------:|:----------------------:|:----------------------:|
| ![](Images/proba1dibujos/distr11.jpg){height="150px"} | ![](Images/proba1dibujos/distr12.jpg){height="150px"} | ![](Images/proba1dibujos/distr13.jpg){height="150px"} |

## Propiedades

|                              $A\cup B$                               |                       $A\cup C$                       |               $(A\cup B)\cap (A\cup C)$               |
|:----------------------:|:----------------------:|:----------------------:|
| ![](Images/proba1dibujos/distr21.jpg){.image-caption height="150px"} | ![](Images/proba1dibujos/distr22.jpg){height="150px"} | ![](Images/proba1dibujos/distr23.jpg){height="150px"} |

## Propiedades

\blue{Complementario del complementario } $$(A^c)^c=A$$
...
|                          $A^c$                          |                          $B^c$                          |                      $A^c\cap B^c$                       |
|:----------------------:|:----------------------:|:----------------------:|
| ![](Images/proba1dibujos/demorgan8.jpg){height="150px"} | ![](Images/proba1dibujos/demorgan9.jpg){height="150px"} | ![](Images/proba1dibujos/demorgan10.jpg){height="150px"} |
...
|                        $A\cap B$                        |                      $(A\cap B)^c$                      |
|:----------------------------------:|:----------------------------------:|
| ![](Images/proba1dibujos/demorgan1.jpg){height="150px"} | ![](Images/proba1dibujos/demorgan2.jpg){height="150px"} |
...
|                          $A^c$                          |                          $B^c$                          |                      $A^c\cup B^c$                      |
|:----------------------:|:----------------------:|:----------------------:|
| ![](Images/proba1dibujos/demorgan3.jpg){height="150px"} | ![](Images/proba1dibujos/demorgan5.jpg){height="150px"} | ![](Images/proba1dibujos/demorgan4.jpg){height="150px"} |

## Definición de probabilidad

La \blue{probabilidad de un suceso} es una puntuación (*score*) numérico entre 0 y 1 que mide la verosimilitud de que este evento se produzca.
...
\blue{Definición formal de probabilidad}
...
\blue{Probabilidad condicionada}: Dados dos sucesos $A$ y $B$, con $P(A)>0$,
la probabilidad $P(B|A)$ de $B$ condicionado a $A$ es la probabilidad
...
\blue{Teorema de la probabilidad total}
...
\blue{Partición del espacio espacio muestral}
...
Sea $A_1,A_2,\ldots,A_n$ una partición de $\Omega$. 
Sea $B$ un suceso cualquiera. Entonces
...
Un dígito de control de error toma el valor 0 en un $99\%$ de los casos en
que hay un error y en un $5\%$ de los mensajes sin error. La probabilidad 
de error en un mensaje es del $0.5\%$.
...
\blue{Positivos y Negativos} Consideremos un problema de predicción de clases binario, en la que los resultados se etiquetan positivos (P) o negativos (N). Hay cuatro posibles resultados a partir de un clasificador binario como el propuesto.
...
\blue{Falsos Positivos y Falsos Negativos}
...
$P(A\cap B)=P(A)+P(B)-P(A\cup B)=0.55+0.2-0.6=0.15$ \red{y} $P(A)\cdot P(B) = 0.55\cdot 0.2=0.11.$
