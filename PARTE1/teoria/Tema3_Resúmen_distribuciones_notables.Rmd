...
\scriptstyle \displaystyle \sum_{i=0}^k {n\choose i}\cdot  p^i\cdot  (1-p)^{n-i} &  
\scriptstyle \mbox{si } \scriptstyle k\leq x< k+1 \mbox{\small  para } \scriptstyle k=0,1,\dots,n,\\ 
\scriptstyle 1 & \scriptstyle  \mbox{ si }  n \leq  x
\end{array}
\right.$.\\\hline
...
$F_Y(y)=P(Y\leq y)=\left\{\begin{array}{ll} 0 & \mbox{ si } y<1\\ 1- (1-p)^{k} & \mbox{ si } \left\{ \begin{array}{l}k\leq y< k+1\\\mbox{para } k=1,2,3,\ldots .\end{array}    \right.\end{array}\right.$ \\\hline
...
Sea $X$ con distribución   geométrica  $Ge(p=0.25)$.  Empezando en $0$.
...
$F_X(x)=P(X\leq x)=\left\{\begin{array}{ll} 0 & \mbox{si } x<0\\\displaystyle\sum_{i=0}^{k} P(X=i)= \displaystyle\sum_{i=0}^{k} \frac{\lambda^i}{i!}\cdot e^{-\lambda} & \mbox{si  }\left\{\begin{array}{l} k\leq x< k+1\\ k=0,1,2,\ldots .\end{array}\right.\end{array}\right.$
     \\\hline
...
$F_X(x)=P(X\leq x)=\left\{\begin{array}{ll} 0 & \mbox{si } x<0\\\displaystyle\sum_{i=0}^{k} P(X=i)= \displaystyle\sum_{i=0}^{k} \frac{(\lambda\cdot t)^i}{i!}\cdot e^{-\lambda\cdot t} & \mbox{si  }\left\{\begin{array}{l} k\leq x< k+1\\\scriptstyle k=0,1,2,\ldots\end{array}\right.\end{array}\right.$
...
\\\hline
Dominio $D_X=\left\{x\in\mathbb{N}\mid \max\{0,k-n\}\leq  x \leq \min\{m,k\}\right\}$\\\hline
$P_X(x)=P(X=x)=\left\{
\begin{array}{ll}
