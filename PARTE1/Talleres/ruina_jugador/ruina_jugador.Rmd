...
1. En la primera apostamos $2^{1-1}=2^0=1$\euro. 
2. Si ganamos hemos ganado 1\euro.
3. Si perdemos apostamos  el doble 2\euro.
4. Si ganamos dejamos de jugar,  tenemos una premio de  2\euro   y hemos 
perdido 
un euro así que ganamos 2-1=1\euro.
...
$2^0+2^1+\cdots+2^{k-1}=
\sum_{k=0}^k 2^k=
\frac{2^0-2^{k-1}}{1-2}=2^{k-1}-1$\euro.
...
Ahora en la jugada $x+1$  apostaré $2^{x}$\euro y si gano tengo un premio de  $2^{x}$\euro y un gasto de $2^{x}-1$ por lo tanto he ganado 1\euro. 
.

¿Cuál es el valor esperado del dinero que tengo que llevar?


Sea $D=$ dinero que tengo que llevar si juego hasta ganar, entonces la apuesta ganadora es $X+1$ y el dinero que tengo que llevar es $D=2^{X}-1$\euro así será una transformación de la v.a $X$ de la que tengo que calcular su valor esperado.
