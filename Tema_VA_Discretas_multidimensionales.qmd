...
| $X\backslash Y$ | $y_1$ | $y_2$ | $\ldots$ | $y_N$ | $P_X(x_i)=\sum_j P_{XY}(x_i,y_j)$ |
|---|---:|---:|---:|---:|:---:|
| $x_1$ | $P_{XY}(x_1,y_1)$ | $P_{XY}(x_1,y_2)$ | $\ldots$ | $P_{XY}(x_1,y_N)$ | $P_X(x_1)$ |
| $x_2$ | $P_{XY}(x_2,y_1)$ | $P_{XY}(x_2,y_2)$ | $\ldots$ | $P_{XY}(x_2,y_N)$ | $P_X(x_2)$ |
| $\vdots$ | $\vdots$ | $\vdots$ | $\vdots$ | $\vdots$ | $\vdots$ |
| $x_M$ | $P_{XY}(x_M,y_1)$ | $P_{XY}(x_M,y_2)$ | $\ldots$ | $P_{XY}(x_M,y_N)$ | $P_X(x_M)$ |
| $P_Y(y_j)=\sum_i P_{XY}(x_i,y_j)$ | $P_Y(y_1)$ | $P_Y(y_2)$ | $\ldots$ | $P_Y(y_N)$ | $1$ |
...
::::: callout-definicion
::: callout-title
Definición de independencia para variables aleatorias bidimensionales discretas. </l>
:::
::: callout-content
...
:::: callout-definicion
::: callout-title
Definición (propiedada) de esperanza de funciones de v.a. discretas bidimensionales
:::
::: callout-content
...
::::: callout-definicion
::: callout-title
Definicón  matriz de varianzas covarianzas 
:::
::: callout-content
