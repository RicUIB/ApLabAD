# Distribuciones notables 2: distribuciones continuas
...
En esta segunda parte del tema de distribuciones notables veremos 
las distribuciones continuas más usuales: uniforme, exponencial y normal.

El lector debe tener en cuenta que exiten muchas otras distribuciones que 
deberá estudiar y algunas ya las hemos visto como la $\chi^2$
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"> Distribución uniforme </i>
:::
::: callout-body
...
El código en `R` para dibujar la función de densidad y la función de 
distribución de una distribución $U(0,1)$ es el siguiente:
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"> Propiedad: Transformación lineal de la v.a. uniforme</i> 
:::
::: callout-body
...
\end{array}
$$
por lo que $T$ sigue una ley $U(scale\cdot a +loc,scale\cdot b +loc)$.
...
::::: callout-definicion
::: callout-title
<i class="bi bi-book"></i> Definición Cuantiles
:::
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Cálculo de cuantiles 
:::
::: callout-body
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"></i> Ejemplo: cuantiles en un un dado
:::
...
A continuación, construimos la función `qdado` que nos calcula el cuantil $p$, para $0\leq p\leq 1$, de la variable $X$ como el mínimo de la antiimagen de $p$ mediante la función de distribución $F_X^{-1}(p)$
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"></i> Ejemplo: Cuantiles Binomial
:::
::: callout-body
...
La distribución exponencial está asociadad al tiempo que transcurre entre dos eventos Poisson
consecutivos.
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Propiedad de la falta de memoria
:::
...
::::: callout-ejemplo
::: callout-title
<i class="bi bi-list-task"></i> Ejemplo: El clásico problema del peluquero.
:::
...
```{r size="scriptsize"}
dexp(0.001,rate=3)# no es una probabilidad es una densidad y puede ser >1
pexp(0.5,rate=3) # P(X<0.5)
rexp(8,3)# ocho tiempos de una exponencial
```
...
::::: callout-ejercicio
::: callout-title
<i class="bi bi-pencil-square"></i> Ejercicio: las bombillas que no envejecen
:::
...
normal estándar y se suele denotar por la letra $Z$ normal $N(0,1)$. El siguiente código la dibuja.

```{r normaldensidad0,fig.align="center",eval=FALSE}
curve(dnorm(x),
      main="Función de densidad de una normal estándar",
      xlim=c(-3.9,3.9))
```

## Gráfica distribución normal o Gaussiana


```{r normaldensidad1,fig.align="center",echo=FALSE}
curve(dnorm(x),
      main="Función de densidad de una normal estándar",
      xlim=c(-3.9,3.9))
```
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Propiedades de la función de densidad de la distribución normal
:::
...
### Resumen de la distribución normal
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Propiedad: transformación lineal la distribución normal
:::
...
::::: callout-proposicion
::: callout-title
<i class="bi bi-clipboard-check"></i> Proiedades normal estándar
:::
::: callout-body
Sea $Z$ una $N(0,1)$.
